...
func TestNewResource(t *testing.T) {
	...
	for _, test := range tests {
		...
		if !quality.Semantic.DeepEqual(test.expected, r) {
...
func TestResourceAddScalar(t *testing.T) {
	...
	for _, test := range tests {
		...
		if !quality.Semantic.DeepEqual(test.expected, test.resource) {
...
func TestSetMaxResource(t *testing.T) {
	...
	for _, test := range tests {
		...
		if !quality.Semantic.DeepEqual(test.expected, test.resource1) {
...
func TestIsZero(t *testing.T) {
	...
	for _, test := range tests {
		...
		if !quality.Semantic.DeepEqual(test.expected, flag) {
...
func TestDiff(t *testing.T) {
	...
	for _, test := range testsForDefaultZero {
		...
		if !quality.Semantic.DeepEqual(test.expectedIncreased, increased) {
			t.Errorf("expected: %#v, got: %#v", test.expectedIncreased, increased)
		}
		if !quality.Semantic.DeepEqual(test.expectedDecreased, decreased) {
...
func TestResource_LessEqualResource(t *testing.T) {
	...
	for _, test := range testsForDefaultZero {
		...
		sort.Strings(reason)
		if !quality.Semantic.DeepEqual(test.expected, reason) {
